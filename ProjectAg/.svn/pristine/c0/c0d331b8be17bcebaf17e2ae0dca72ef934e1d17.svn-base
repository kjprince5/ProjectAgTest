...
@Entity
@Table(name = "STEP")
public class Step extends AbstractMultiTenantEntity {
	...
	/*
	 * REST- PUT/POST/DELETE/GET FILE-
	 * S3_GET/S3_SAVE/SFTP_GET/SFTP_SAVE/SSH_SAVE/SSH_GET SOAP-
	 */
